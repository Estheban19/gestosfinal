...
def condicionalesLetras(dedos, frame):
    ...
    letras = {
       ...
       # Lengua de señas adicional
       'Gracias': {'dedos': [1, 0, 0, 0, 0]},  # Gesto de gracias (pasar la mano desde la barbilla hacia adelante)
       'Perdón': {'dedos': [0, 1, 0, 0, 0]},  # Gesto de perdón (mano en la barbilla y moviendo en círculos)
       'Sí': {'dedos': [1, 0, 0, 0, 0]},  # Gesto afirmativo (puño cerrado y luego moviendo la cabeza)
       'No': {'dedos': [1, 1, 0, 0, 0]},  # Gesto negativo (poniendo la mano en forma de "no")
       'Por Favor': {'dedos': [1, 0, 1, 0, 0]},  # Gesto de "por favor" (mano abierta en la frente)
       'Te Quiero': {'dedos': [1, 1, 1, 0, 1]},  # Gesto de "te quiero" (dedos índice, medio y meñique levantados)
       'Ayuda': {'dedos': [0, 1, 1, 0, 0]},  # Gesto de ayuda (dedos índice y medio levantados)
       'Familia': {'dedos': [1, 0, 1, 0, 1]},  # Gesto de familia (dedos índice y meñique levantados)
}
